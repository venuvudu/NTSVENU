...
var map = {
	...
	"../pages/mainview/mainview.module": [
		272,
		6
	],
	...
	"../pages/uploadcontent/uploadcontent.module": [
		277,
		1
	]
};
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["c" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_5__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/mainview/mainview.module#MainviewPageModule', name: 'MainviewPage', segment: 'mainview', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/menu/menu.module#MenuPageModule', name: 'MenuPage', segment: 'menu', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/profile/profile.module#ProfilePageModule', name: 'ProfilePage', segment: 'profile', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/signup/signup.module#SignupPageModule', name: 'SignupPage', segment: 'signup', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/tabs/tabs.module#TabsPageModule', name: 'TabsPage', segment: 'tabs', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/uploadcontent/uploadcontent.module#UploadcontentPageModule', name: 'UploadcontentPage', segment: 'uploadcontent', priority: 'low', defaultHistory: [] }
                    ]
                })
            ],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Notus\DIZZM\dizzmApp-n\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"E:\Notus\DIZZM\dizzmApp-n\src\app\app.html"*/
        }),
